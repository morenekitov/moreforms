...
- использовать workspace как внутренний operating system команды, а не как финальный клиентский продукт.
...
При этом сейчас важно держать две разные сущности:

- внутренний `shared workspace`, который помогает команде вести discovery;
- внешний AI-native B2B SaaS, который только формируется через интервью и synthesis.
...
На текущем этапе сами артефакты должны отвечать на вопрос:

- в какой из трех pain areas у нас strongest wedge:
